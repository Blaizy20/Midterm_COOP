...
require_login();
require_roles(['CASHIER','ADMIN','MANAGER','LOAN_OFFICER','CREDIT_INVESTIGATOR']);
...
$loan = fetch_one(q("SELECT remaining_balance FROM loans WHERE loan_id=?", "i", [$payment['loan_id']]));
