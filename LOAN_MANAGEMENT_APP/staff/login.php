...
<div style="display:flex;justify-content:center;align-items:center;min-height:calc(100vh - 58px);padding:22px">
  <div class="card auth-card">
    <div style="text-align:center">
      <img src="<?php echo htmlspecialchars($settings['logo_path'] ?? APP_BASE . '/assets/img/logo.png'); ?>" alt="Logo" style="height:56px;border-radius:14px;background:white;padding:6px"/>
    ...
    <form method="post">
      ...
      <div style="margin-top:10px">
        <a class="small" href="<?php echo APP_BASE; ?>/forgot_password.php">Forgot password?</a>
      </div>
    </form>
  </div>
</div>
