...
class AuthService {
     ...
     */
    public function authenticateStaffUser($username, $password) {
        try {
            // Ensure user is NOT a customer (staff-only web portal)
            $sql = "SELECT user_id, username, password_hash, full_name, role, email, contact_no, is_active 
                    FROM users 
    ...
    public function getUserById($userId) {
        try {
            $sql = "SELECT user_id, username, full_name, role, email, contact_no, is_active 
