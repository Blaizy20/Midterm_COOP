...
function log_activity($action, $description, $loan_id = null, $customer_id = null, $reference_no = null) {
  ...
  try {
    q("INSERT INTO activity_logs (user_id, user_role, action, description, loan_id, customer_id, reference_no) 
       VALUES (?, ?, ?, ?, ?, ?, ?)",
      "isssiis", [$user_id, $user_role, $action, $description, $loan_id, $customer_id, $reference_no]);
  } catch (Exception $e) {
